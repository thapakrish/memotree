            ...
            {messageEvents.map((event, index) => {
                switch (event.kind) {
                    ...
                    case 'image_artifact': {
                        ...
                        return (
                            <div key={`${event.kind}-${event.artifact.id}`} className="flex gap-3 rounded-xl border border-slate-200 bg-slate-50 p-2">
            ...
            >
                {!provider ? (
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        {canvasSelectedArtifactIds.length > 0 && (
                            <div className="flex flex-wrap items-center gap-2 rounded-xl border border-blue-200 bg-blue-50 px-3 py-2">
                                ...
                                <button
                                    ...
                                    className="rounded-md p-1 text-blue-500 transition-colors hover:bg-blue-100 hover:text-blue-700"
